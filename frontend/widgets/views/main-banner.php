<div class="banners home4-banner techmarket-banner">
    <div class="row">
        <div class="banner text-in-right">
            <a href="#">
                <div style="background-size: cover; background-position: center center; background-image: url( /images/banner/4-1.jpg ); height: 484px;" class="banner-bg">
                    <div class="caption">
        ...
        <div class="banner text-in-left">
            <a href="#">
                <div style="background-size: cover; background-position: center center; background-image: url( /images/banner/4-2.jpg ); height: 484px;" class="banner-bg">
                    <div class="caption">
                        <div class="banner-info">
